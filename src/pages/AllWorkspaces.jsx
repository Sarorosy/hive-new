...
const AllWorkspaces = () => {
  ...
  return (
    <main className="bg-white min-h-screen pt-24">
      ...
      <section className="py-16 px-4 md:px-8 xl:px-0 bg-white">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {solutionOfferings.map((offering) => (
              <article
                key={offering.id}
                className="border border-slate-200 rounded-2xl p-6 space-y-5 shadow-sm hover:shadow-xl transition-shadow"
              >
                ...
                <div className="flex flex-wrap gap-3">
                  {offering.items.map((item) => (
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-[#0e1932] text-white px-4 py-2 text-xs font-semibold uppercase tracking-wider hover:bg-black transition-colors"
                    >
                      {item.name}
      ...
      <section className="bg-[#0e1932] text-white py-16 px-4 md:px-8 xl:px-0">
