...
const StartWithUs = ({ theme }) => {
  // Auto classes based on theme
  ...
  const invertImg = theme === "dark" ? "invert-[0.95] brightness-110" : "";

  return (
    <div className={`${bgPrimary} py-16 px-4 transition`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Take a Tour */}
          <div className={`rounded-lg p-8 shadow-sm border ${cardBg} transition`}>
            <div className="mb-6">
              <img
                src={virtual}
                alt="Workspace Tour"
            ...
            <h3 className={`text-xl font-medium mb-4 ${textPrimary}`}>Take a tour</h3>
          ...
          <div className={`rounded-lg p-8 shadow-sm border ${cardBg} transition`}>
            <div className="mb-6">
              ...
              >
                <g>
                  ...
                  <path d="M15 45 L40 30 L65 45 L40 60 Z"
                    fill="#f3f4f6" stroke="#333" strokeWidth="1.5" />
                  <path d="M15 45 L15 60 L40 75 L40 60 Z"
                    fill="#e5e7eb" stroke="#333" strokeWidth="1.5" />
                  <path d="M40 60 L40 75 L65 60 L65 45 Z"
                    fill="#d1d5db" stroke="#333" strokeWidth="1.5" />
                  <path d="M35 50 L40 47 L45 50 L45 56 L40 59 L35 56 Z"
                    fill="#D4AF37" />
            ...
            <h3 className={`text-xl font-medium mb-4 ${textPrimary}`}>Choose an office</h3>
            <p className={`${textSecondary} leading-relaxed`}>
            ...
            <div className="mb-6">
              ...
              >
                <g>
                  ...
                  <g fill="#333" fontSize="8" fontFamily="Arial">
                  ...
                  <path d="M65 38 L68 40 L65 42"
                    fill="none" stroke="#666" strokeWidth="1.5" strokeLinecap="round" />
                </g>
              </svg>
            </div>

            <h3 className={`text-xl font-medium mb-4 ${textPrimary}`}>Move-in</h3>
            <p className={`${textSecondary} leading-relaxed`}>
              Make yourself at home. We'll ensure your office is fully operational from day one.
            </p>
          </div>
