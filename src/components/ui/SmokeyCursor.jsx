...
export default function SmokeyCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Choose randomly between the two golden colors
      const colors = [
        { r: 246/255, g: 216/255, b: 160/255 }, // Light golden
        { r: 218/255, g: 183/255, b: 118/255 }  // Darker golden
      ];
      
      const selectedColor = colors[Math.floor(Math.random() * colors.length)];
      
      // Apply intensity multiplier (you can adjust this value)
      return {
